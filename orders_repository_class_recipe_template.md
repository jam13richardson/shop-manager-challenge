...
Columns:
id | customer_name | item_name | order_date | 
```
...
INSERT INTO orders (customer_name, item_name, order_date) VALUES ('Jamie', 'Chutney', '2023-04-01');
INSERT INTO orders (customer_name, item_name, order_date) VALUES ('Ian', 'Cheese', '2022-12-31');
```
